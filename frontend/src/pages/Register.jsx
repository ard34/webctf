...
import { validateUsername, validatePassword, validateEmail } from '../utils/security';
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 py-12">
      ...
      >
        ...
        >
          <h1 className="text-3xl font-bold gradient-text mb-2">Join CTF Platform</h1>
          <p className="text-white/70">Create your account to start hacking</p>
        </motion.div>
